                        ...
                        for m in range(len(muteTab)):
                            ...
                            for n in range(len(crossTab)):
                                ...
                                for o in range(len(selectTab)):
                                    ...
                                    linPrd = prd
                                    arr4 = [populationList[i],eliteList[j],mutationRateList[k],iterations[l],m,n,o]



                                    print("Best result for: " + str(files[4]) + " Cost: " + str(linBest) + " Prd: " + str(linPrd) + " Parameters: " + str(arr4))
                                    f = open("ResultsAdaptinglin105Part3" + str(m) + str(n) + str(o) + ".txt", "x")
                                    f.write("Best result for: " + str(files[4]) + " Cost: " + str(linBest) + " Prd: " + str(linPrd) + " Parameters: " + str(arr4))
                                    f.close()
