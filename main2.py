                        ...
                        for m in range(len(muteTab)):
                            ...
                            for n in range(len(crossTab)):
                                ...
                                for o in range(len(selectTab)):
                                    ...
                                    eilPrd = prd
                                    arr2 = [populationList[i],eliteList[j],mutationRateList[k],iterations[l],m,n,o]



                                    print("Best result for: " + str(files[2]) + " Cost: " + str(eilBest) + " Prd: " + str(eilPrd) + " Parameters: " + str(arr2))
                                    f = open("ResultsAdaptingeil76Part3" + str(m) + str(n) + str(o) + ".txt", "x")
                                    f.write("Best result for: " + str(files[2]) + " Cost: " + str(eilBest) + " Prd: " + str(eilPrd) + " Parameters: " + str(arr2))
                                    f.close()
